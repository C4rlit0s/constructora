...
?>
<div id="<?php echo esc_attr($atts['html_id']);?>" class="cms-heading-wrapper cms-heading-layout4">
        <div class="cms-heading-content">
            <?php if(!empty($title4)) { ?>
            <h2 class="title" style="<?php echo wp_kses_post($inline_style);?> text-transform: <?php echo esc_attr($text_transform);?>; color:<?php echo esc_attr($title_color); ?>; font-size: <?php echo esc_attr($title_size); ?>;">
                <?php echo wp_kses_post($title4); ?>
            </h2>
            <?php } ?>
            <div class="supb-title custom-font3" style="color:<?php echo esc_attr($title_color); ?>; font-size:<?php echo esc_attr($description_size); ?>">
