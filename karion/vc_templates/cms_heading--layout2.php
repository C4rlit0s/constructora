...
<div id="<?php echo esc_attr($atts['html_id']);?>" class="cms-heading-wrapper cms-heading-layout2">
        <div class="cms-heading-content">
            <h2 class="title" style="<?php echo wp_kses_post($inline_style); ?> font-size:<?php echo esc_attr($title_font_size); ?>;color:<?php echo esc_attr($title_color); ?>; letter-spacing: <?php echo esc_attr($letter_spacing);?>;">
                <?php echo wp_kses_post($title); ?>
            </h2>
            <div class="line-title-bottom">
                <span class="span-line-left" style="background-color: <?php echo esc_attr($title_color);?>"></span>
                <span class="span-bullet"></span>
                <span class="span-line-right" style="background-color: <?php echo esc_attr($title_color);?>"></span>
            </div>
        </div>
</div>