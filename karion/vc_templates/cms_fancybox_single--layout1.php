...
?>
<div class="cms-fancybox-wraper cms-fancybox-layout1 <?php echo esc_attr($atts['template']);?>" id="<?php echo esc_attr($atts['html_id']);?>">
    <div class="cms-fancybox-item" >
        ...
        <div class="cms-fancybox-content">
            ...
            <?php if($atts['description_item']): ?>
                <div class="cms-fancybox-description custom-font4" style="color:<?php echo esc_attr($decs_color); ?>;">
