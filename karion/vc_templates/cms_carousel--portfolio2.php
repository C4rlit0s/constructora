...
<div class="cms-carousel cms-carousel-portfolio2 <?php echo esc_attr($atts['template']);?> nav-style-<?php echo esc_attr($nav_style); ?> dot-style-<?php echo esc_attr($dot_style); ?> margin-<?php echo esc_attr($margin_dots_style); ?> box-style-<?php echo esc_attr($box_style); ?>" id="<?php echo esc_attr($atts['html_id']);?>">
    <?php
    $posts = $atts['posts'];
            ...
            <div class="cms-carousel-item">
                ...
                <div class="entry-blog-crs-portfolio <?php echo esc_attr($class); ?>">
                    ...
                    <div class="entry-meta">
                        ...
                        <a class="read-more" href="<?php the_permalink(); ?>"><?php esc_html_e('See more', 'construct') ?></a>
                    </div>
                </div>
            </div>
        <?php
