...
vc_map(array(
    ...
    "params" => array(
        array(
            "type" => "textfield",
            "heading" => __ ( 'Video Url', 'construct' ),
        ...
        array(
            "type" => "dropdown",
            "class" => "",
            "heading" => esc_html__("Add Intro Video", 'construct'),
            "admin_label" => true,
        ...
        array(
            "type" => "attach_image",
            "heading" => __ ( 'Video Intro', 'construct' ),
        ...
        array(
            "type" => "textfield",
            "heading" => __ ( 'Intro Height', 'construct' ),
        ...
        array(
            "type" => "colorpicker",
            "heading" => esc_html__("Overlay", 'construct'),
            "param_name" => "overlay",
            "value" => "",
            "dependency" => array(
                "element"=>"intro_custom",
