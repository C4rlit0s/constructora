...
class CMSSuperHeroes_StaticCss
{
    ...
    public function css_render()
    {
        ...
        if (is_page() && !empty($opt_theme_options['main_logo_height']['height'])) {
            echo "@media screen and (min-width: 992px) { #cshero-header-inner #cshero-header-logo img {
        ...
        if (is_page() && !empty($opt_theme_options['sticky_logo_height']['height'])) {
            echo "@media screen and (min-width: 992px) { #cshero-header-inner #cshero-header-holder .header-fixed #cshero-header-logo img {
                max-height: ".esc_attr($opt_theme_options['sticky_logo_height']['height'])."!important;
            }}";
        }
