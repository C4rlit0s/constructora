 ...
 *
 */
function construct_set_home_page(){
...
add_action('cms_import_finish', 'construct_set_home_page');
 ...
 *
 */
function construct_set_menu_location(){
...
add_action('cms_import_finish', 'construct_set_menu_location');