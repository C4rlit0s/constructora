...
function cms_theme_register_required_plugins() {
    ...
    $plugins = array(
        array(
            'name'               => esc_html__('EF3-Framework', 'construct'),
            'slug'               => 'EF3-Framework',
            'source'             => esc_url('http://farost.net/plugins/EF3-Framework.zip'),
            'required'           => true,
        ),
        array(
            'name'               => esc_html__('Karioncore', 'construct'),
            'slug'               => 'karioncore',
            'source'             => esc_url('http://farost.net/plugins/karioncore.zip'),
            'required'           => true,
        ),
        array(
            'name'               => esc_html__('Visual Composer', 'construct'),
            'slug'               => 'js_composer',
            'source'             => esc_url('http://farost.net/plugins/js_composer.zip'),
            'required'           => true,
        ),

        array(
            'name'               => esc_html__('Revolution Slider', 'construct'),
            'slug'               => 'revslider',
            'source'             => esc_url('http://farost.net/plugins/revslider.zip'),
            'required'           => false,
        ),

        array(
            'name'               => esc_html__('EF3 Import And Export', 'construct'),
            'slug'               => 'ef3-import-and-export',
            'source'             => esc_url('http://farost.net/plugins/ef3-import-and-export.zip'),
            'required'           => true,
        ),

        array(
            'name'               => esc_html__('Custom Post Type UI', 'construct'),
            'slug'               => 'custom-post-type-ui',
            'required'           => true,
        ),

        array(
            'name'               => esc_html__('Force regenerate thumbnail', 'construct'),
        ...
        array(
            'name'               => esc_html__('Newsletter', 'construct'),
            'slug'               => 'newsletter',
            'required'           => false,
        ),
        // array(
